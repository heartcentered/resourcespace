...
/* The permissions check here is intentionally more basic. It does not check edit_filter, as this would be
 * computationally intensive when displaying many resources. As such, this is a convenience feature for users that have
 * system-wide edit access to the given access level. */
