...
# Check the ResourceSpace version.
...
?><tr><td><?php echo str_replace("?", "PHP GD", $lang["softwareversion"]); ?></td><td><?php echo $version?></td><td><b><?php echo $result?></b></td></tr><?php
...
// Check for write access to homeanim if the transform plugin is installed.
...
function display_extension_status($extension)
    ...
    ?><tr><td colspan="2">PHP <?php echo strtoupper($extension) . " extension"?></td>
    <td><b><?php echo $result?></b></td></tr><?php
    }
