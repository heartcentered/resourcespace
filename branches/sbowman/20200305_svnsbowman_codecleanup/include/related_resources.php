...
if($enable_related_resources)
    ...
    $relatedresources_count = count($relatedresources);

    for($n = 0; $n < $relatedresources_count; $n++)
        {
    ...
    if(isset($related_type_show_with_data))
        ...
        foreach($related_type_show_with_data as $rtype)
            {
            // Is this a resource type that needs to be displayed? Do not show resources of the same type as this is not the standard configuration.
            ...
            // We have displayed these, do not show them again later.
